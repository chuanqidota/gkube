...
async function handleBatchDelete() {
  ...
  try {
    await ElMessageBox.confirm(
      t('common.batchDeleteConfirm', { count: selectedRows.value.length, type: 'LimitRange' }),
      t('common.confirm'),
      { type: 'warning' },
    )
    let count = 0
    ...
    ElMessage.success(t('common.batchDeleteSuccess', { count, type: 'LimitRange' }))
    fetchLimitRanges()
  } catch {
    /* cancelled */
  }
  ...
  <div class="page-container">
    ...
    <el-card shadow="never" class="table-card">
      ...
      >
        ...
        <el-table-column :label="t('config.limits')" min-width="300">
          <template #default="{ row }">
            <div
