...
import { createConfigMap } from '@/api/resource'
...
async function handleYamlSubmit() {
  ...
  try {
    ...
    await createConfigMap({ namespace: ns, yaml: yamlContent.value })
...
<style scoped>
.configmap-create { max-width: 1100px; margin: 0 auto; padding: var(--gk-space-5) 0; }
