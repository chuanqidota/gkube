...
import { getNetworkPolicyList, getNetworkPolicyYaml, deleteNetworkPolicy, getNamespaceList } from '@/api/resource'
  ...
  <div class="page-container">
    <el-card shadow="never" class="filter-card">
      <div class="filter-bar">
        ...
        <el-button type="primary" @click="fetchNetworkPolicies"><el-icon><Refresh /></el-icon> Refresh</el-button>
