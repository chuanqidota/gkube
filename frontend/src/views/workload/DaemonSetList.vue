  ...
  <div class="page-container">
    ...
    <el-card shadow="never" class="table-card">
      ...
      >
        ...
        <el-table-column prop="desired" label="Desired" width="90" />
        <el-table-column prop="current" label="Current" width="90" />
        <el-table-column prop="ready" label="Ready" width="90" />
        <el-table-column prop="updateStrategy" label="Strategy" width="120" />
