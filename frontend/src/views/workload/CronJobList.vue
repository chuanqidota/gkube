...
import { getCronJobList, getCronJobYaml, deleteCronJob, getNamespaceList, extractNamespaceNames } from '@/api/resource'
...
const { isRunning, countdown, toggle, refresh } = useAutoRefresh(fetchCronJobs)
