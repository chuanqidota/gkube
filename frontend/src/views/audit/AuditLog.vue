...
const {
  ...
  setIntervalOption,
} = useAutoRefresh(fetchAuditLogs, { autoStart: false })
  ...
  <div class="page-container">
      ...
      <div class="filter-bar">
        ...
        <div class="filter-right">
          ...
          <el-button type="danger" @click="clearLogs"
            ><el-icon><Delete /></el-icon> {{ t('common.clear') }}</el-button
          >
          <AutoRefreshToolbar
    ...
    <el-card shadow="never">
      ...
      <el-empty
        ...
        :description="t('audit.noAuditLogs')"
      />
    </el-card>
  </div>
</template>
...
.stat-card.success {
  border-left: 4px solid var(--gk-color-success);
}
.stat-card.danger {
  border-left: 4px solid var(--gk-color-danger);
}
.stat-value {
